  ...
  return (
    <Fragment>
      <div className="w-full bg-[#F6F8FB] ">
        {/* Mobile Header */}
        <div className=" w-11/12 h-18 m-auto font-IRANSans pt-[31px] bg-[#F6F8FB] md:hidden flex flex-col flex-nowrap justify-center items-center gap-5">
          <div className="w-full h-8 flex flex-row flex-nowrap justify-between items-center  ">
        ...
        {/*Desktop  Header */}
        <div className="bg-[#F6F8FB] hidden md:flex xl:hidden flex-col flex-nowrap justify-center items-center w-9/12 h-32 m-auto gap-4 font-IRANSans ">
          <div className=" flex flex-row flex-nowrap justify-between items-center w-full h-10">
            ...
            <div className="flex flex-row flex-nowrap justify-end items-center gap-3 w-1/2">
              ...
              {/* <!-- hamburgur menu --> */}
              <HamburgerMenu
                className="flex flex-wrap h-10 w-1/12 py-2 items-center justify-end "
                menuItems={menuItems}
              />
            </div>
          </div>
