...
const Backdrop = (props) => {
  return (
    <div
      className="fixed w-full h-full top-0 right-0 z-40 flex flex-row justify-center bg-[rgba(246, 248, 251, 0.07)] backdrop-blur-[6px]"
