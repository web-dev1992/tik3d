...
const Tik3dBanner = () => {
    return (  <div className="w-[330px] md:w-9/12 lg-w-[802px] xl:w-[1290px] h-[180px] lg:h-[124px] xl:h-[200px] m-auto pr-8 pl-6 pt-[26px]  lg:pl-8 lg:py-5 lg:pr-[51px] xl:py-[34px] xl:pr-20 xl:pl-5 text-white font-IRANSans flex flex-col md:flex-row-reverse  flex-nowrap  justify-center items-center lg:justify-start gap-5 lg:gap-9 xl:gap-12 rounded-[10px] bg-[#2F80ED] mb-10">
    ...
    <div className="w-full md:w-1/2 flex flex-row-reverse flex-nowrap gap-[30px] xl:gap-[48px] justify-end  ">
